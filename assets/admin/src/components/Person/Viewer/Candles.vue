  ...
  <b-row no-gutters>
    <b-col md="6" offset-md="3">
      <div class="candle-pot">
        ...
        <b-popover target="candle-1" triggers="hover" placement="top">
        ...
        <b-popover target="candle-2" triggers="hover" placement="top">
          <template #title>Popover Title</template>
          I am popover <b>component</b> content!
        </b-popover>
      </div>
      <div class="candle-pot-odd">
        <div class="candle" id="candle-1">
          <div class="flame">
            <div class="shadows"></div>
            <div class="top"></div>
...
.wick {
  ...
  &:after {
    ...
    width: 0px;
    height: 0px;
    box-shadow: 0 5px 2px 3px gold, 14px 2px 14px gold,
