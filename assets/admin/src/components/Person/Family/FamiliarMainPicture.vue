      ...
      <b-row>
        ...
        >
          <b-img
            ...
            fluid
            :src="familiar.mainPictureBase64"
          ></b-img>
...
export default {
  ...
  methods: {
    ...
    async uploadPicture() {
      if (this.$props.familiar.mainPicture) {
      ...
      const response = await PersonApi.uploadFamiliarMainPicture(
        this.$props.familiar.id,
        formData
      );
